...
passport.serializeUser((user, done) => {
  done(null, user.id); // save the token into the user session using the user ID.
});
...
passport.deserializeUser((id, done) => {
  ...
  }); // takes the user id from the token and returns the user object., and attaches it to the request object as req.user
});
